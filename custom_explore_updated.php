...
<body>
    ...
    <script>
        function selectVenue(venueName, venueCost) {
            ...
            window.location.href = `custom_wed_updated.php?venue=${encodeURIComponent(venueName)}&cost=${venueCost}&event_type=${eventType}&date=${selectedDate}&time=${selectedTime}`;
        }
    </script>
